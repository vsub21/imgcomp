...
# dealing with arg_scope

# from tensorflow.contrib.framework.python.ops import arg_scope # applies kwargs to all list_ops_or_scope within scope of arg_scope
# from caffe2.python.helpers import arg_scope
from model_utils import arg_scope
